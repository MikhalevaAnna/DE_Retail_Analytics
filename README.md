...
4) Создаются таблицы в `ClickHouse` в сыром слое сразу с правильными типами данных.
  ...
  для сохранения исходных данных. В этом поле хранится список вложенных **JSON**-структур. </br>
...
В случае превышения > 50 % дубликатов в исходных таблицах - алертить в телеграмм при помощи Grafana. 
