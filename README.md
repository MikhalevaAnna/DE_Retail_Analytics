...
3) Вывод 3-х документов из **MongoDB**
   - Можно увидеть в логах [logs/pipeline_retail_data/check_mongo_data_task/](logs/dag_id=pipeline_retail_data/task_id=check_mongo_data_task/attempt=1.log) или на скриншоте:</br>
